...
=======
>>>>>>> efe37ae915a1ccc39feaa1de3a14f93750cc0053
```{r}
...
SB_Aberdeen_ARIMA_Plot <- autoplot(SB_Aberdeen_ARIMA) +
  autolayer(SB_Aberdeen_Test, series = "Test set")

SB_Aberdeen_ets_Plot <- autoplot(SB_Aberdeen_ets) +
  autolayer(SB_Aberdeen_Test, series = "Test set")

SB_Aberdeen_nn_Plot <- autoplot(SB_Aberdeen_nn) +
  autolayer(SB_Aberdeen_Test, series = "Test set")

SB_Aberdeen_ma_Plot <- autoplot(SB_Aberdeen_ma) +
  autolayer(SB_Aberdeen_Test, series = "Test set")

plot_grid(SB_Aberdeen_ARIMA_Plot, SB_Aberdeen_ets_Plot, SB_Aberdeen_nn_Plot, SB_Aberdeen_ma_Plot, ncol=2)
=======
...
```{r}
<<<<<<< HEAD
SC_Aberdeen_ARIMA_Plot <- autoplot(SC_Aberdeen_ARIMA) +
  autolayer(SC_Aberdeen_Test, series = "Test set")

SC_Aberdeen_ets_Plot <- autoplot(SC_Aberdeen_ets) +
  autolayer(SC_Aberdeen_Test, series = "Test set")

SC_Aberdeen_nn_Plot <- autoplot(SC_Aberdeen_nn) +
  autolayer(SC_Aberdeen_Test, series = "Test set")

SC_Aberdeen_ma_Plot <- autoplot(SC_Aberdeen_ma) +
  autolayer(SC_Aberdeen_Test, series = "Test set")

plot_grid(SC_Aberdeen_ARIMA_Plot, SC_Aberdeen_ets_Plot, SC_Aberdeen_nn_Plot, SC_Aberdeen_ma_Plot, ncol=2)
=======
...
```{r}
<<<<<<< HEAD
SB_Jordan_ARIMA_Plot <- autoplot(SB_Jordan_ARIMA) +
  autolayer(SB_Jordan_Test, series = "Test set")

SB_Jordan_ets_Plot <- autoplot(SB_Jordan_ets) +
  autolayer(SB_Jordan_Test, series = "Test set")

SB_Jordan_nn_Plot <- autoplot(SB_Jordan_nn) +
  autolayer(SB_Jordan_Test, series = "Test set")

SB_Jordan_ma_Plot <- autoplot(SB_Jordan_ma) +
  autolayer(SB_Jordan_Test, series = "Test set")

plot_grid(SB_Jordan_ARIMA_Plot, SB_Jordan_ets_Plot, SB_Jordan_nn_Plot, SB_Jordan_ma_Plot, ncol=2)
=======
...
```{r}
<<<<<<< HEAD
SC_Jordan_ARIMA_Plot <- autoplot(SC_Jordan_ARIMA) +
  autolayer(SC_Jordan_Test, series = "Test set")

SC_Jordan_ets_Plot <- autoplot(SC_Jordan_ets) +
  autolayer(SC_Jordan_Test, series = "Test set")

SC_Jordan_nn_Plot <- autoplot(SC_Jordan_nn) +
  autolayer(SC_Jordan_Test, series = "Test set")

SC_Jordan_ma_Plot <- autoplot(SC_Jordan_ma) +
  autolayer(SC_Jordan_Test, series = "Test set")

plot_grid(SC_Jordan_ARIMA_Plot, SC_Jordan_ets_Plot, SC_Jordan_nn_Plot, SC_Jordan_ma_Plot, ncol=2)
=======
